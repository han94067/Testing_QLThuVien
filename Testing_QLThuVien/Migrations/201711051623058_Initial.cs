        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        SoLuong = c.Int(),
                        SoLuongTon = c.Int(),
                        TriGia = c.Decimal(nullable: false, precision: 9, scale: 0),
                        TinhTrang = c.Int(),
                        MoTa = c.String(),
                    })
                ...
                c => new
                    {
                        ...
                        NgayQuaHan = c.Int(),
                        TinhTrangMuon = c.Int(),
                        SoLuongThue = c.Int(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        IDDocGia = c.String(nullable: false, maxLength: 5, fixedLength: true, unicode: false),
                        SoDienThoai = c.String(nullable: false, maxLength: 11, unicode: false),
                        MatKhau = c.String(maxLength: 100, unicode: false),
                        TenDocGia = c.String(nullable: false, maxLength: 50),
                        DiaChi = c.String(nullable: false, maxLength: 100),
                        Email = c.String(nullable: false, maxLength: 50, unicode: false),
                        CMND = c.String(nullable: false, maxLength: 9, fixedLength: true, unicode: false),
